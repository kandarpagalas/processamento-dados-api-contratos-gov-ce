...
from data.dataset_contratos import dados_grafico_descricao_situacao, lista_anos
...
df = dados_grafico_descricao_situacao(year=year)
if year == "Todos":
...
with col2:
    ...
    grafico = px.bar(
        ...
        labels= {"descricao_situacao": "Situação do contrato", "sum": "R$"},
